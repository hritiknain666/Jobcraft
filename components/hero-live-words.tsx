...
export default function HeroLiveWords() {
  ...
  return (
    <div className="mt-5 inline-flex min-h-12 items-center rounded-2xl border border-violet-100 bg-white/80 px-4 py-2 shadow-sm backdrop-blur">
      ...
      <span
        key={words[index]}
        className="live-word bg-gradient-to-r from-violet-600 via-fuchsia-500 to-indigo-500 bg-clip-text text-lg font-black text-transparent sm:text-xl"
      >
        {words[index]}
      </span>
      <style jsx>{`
        ...
        .live-word {
          animation: liveWordIn 0.45s ease both;
        }
