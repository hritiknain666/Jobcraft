  ...
  return (
    <>
      ...
      <nav
        ...
        className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/95 px-2 pb-[max(.5rem,env(safe-area-inset-bottom))] pt-2 shadow-[0_-12px_35px_rgba(15,23,42,.08)] backdrop-blur-xl md:hidden"
      >
        <div className="mx-auto grid max-w-lg grid-cols-5 items-end">
          ...
          <details className="group relative">
            ...
            <div className="absolute bottom-16 right-1 w-56 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-[0_20px_60px_rgba(15,23,42,.18)]">
              {[
                ["Profile", "/profile"],
                ...
                <Link key={href} href={href} className="block rounded-xl px-4 py-3 text-sm font-bold text-slate-700 hover:bg-slate-50">
                  {label}
                </Link>
              ))}
            </div>
