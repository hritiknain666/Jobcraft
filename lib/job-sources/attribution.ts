...
export function getProviderAttribution(
  ...
  if (normalized === "arbeitnow") {
    return {
      label: "Source: Arbeitnow",
      href: applyUrl || "https://www.arbeitnow.com/",
      requiredPerListing: true,
    };
  }
  if (normalized === "remotive") {
    return {
      label: "Source: Remotive",
      href: applyUrl || "https://remotive.com/",
      requiredPerListing: true,
    };
  }
  if (normalized === "jobicy") {
    return {
      label: "Source: Jobicy",
      href: applyUrl || "https://jobicy.com/",
      requiredPerListing: true,
    };
  }
  ...
  if (normalized === "remote ok") {
    return {
      label: "Source: Remote OK",
      href: applyUrl || "https://remoteok.com/",
      requiredPerListing: true,
    };
  }
  if (normalized === "jooble") {
    return {
      label: "Source: Jooble",
      href: applyUrl || "https://jooble.org/",
      requiredPerListing: false,
    };
  }
  if (normalized === "indianapi") {
    return {
      label: "Source: IndianAPI",
  ...
  if (normalized === "greenhouse") {
    return {
      label: "Employer listing via Greenhouse",
      href: applyUrl ?? null,
      requiredPerListing: false,
    };
  }
  if (normalized === "lever") {
    return {
      label: "Employer listing via Lever",
      href: applyUrl ?? null,
      requiredPerListing: false,
    };
  }
