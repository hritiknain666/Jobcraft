  ...
  return (
    <AuthPageShell mode="login">
      ...
      <div className="mt-7 rounded-2xl border border-[#cfe0d8] bg-[#e9f4ed] p-4">
        <p className="text-sm font-black text-[#285844]">Reset your password</p>
        <p className="mt-1 text-sm leading-6 text-[#5f786f]">
          Enter the email linked to your JobCraft account. We&apos;ll send a secure recovery link if
          the account exists.
        </p>
      </div>
      <form action={requestPasswordReset} className="mt-5 space-y-4">
        ...
        <button className="jc-button-primary w-full !py-4">Send secure reset link →</button>
      </form>
      <p className="mt-6 text-center text-sm text-[#789087]">
        Remembered your password?{" "}
        <Link href="/auth/login" className="font-black text-[#278363]">
          Back to login
        </Link>
      </p>
    </AuthPageShell>
